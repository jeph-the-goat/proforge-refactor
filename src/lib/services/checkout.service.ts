...
import { ICheckoutService, CheckoutOptions } from './interfaces/checkout.interface'
  ...
  async createCheckoutSession(
    ...
    try {
      ...
      const session = await stripe.checkout.sessions.create({
        ...
        mode: 'subscription',
        success_url: options.successUrl || `${getDomain()}/success?session_id={CHECKOUT_SESSION_ID}`,
